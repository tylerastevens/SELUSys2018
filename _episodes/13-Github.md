...
Copy that URL from the browser, go into the local `my_project` repository, and run
this command:

~~~
$ git remote add origin https://github.com/vlad/my_project.git
~~~
{: .bash}
...
~~~
origin   https://github.com/vlad/my_project.git (push)
origin   https://github.com/vlad/my_project.git (fetch)
~~~
{: .output}
...
To https://github.com/vlad/my_project
