...
Create a directory for your class project. Call it something more descriptive than what I've called this below:
...
Then we tell Git to make `my_project` a [repository]({{ page.root }}/reference/#repository)—a place where
